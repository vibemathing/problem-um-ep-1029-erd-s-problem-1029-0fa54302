...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1029-erd-s-problem-1029-0fa54302-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1029"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1029-erd-s-problem-1029-0fa54302-v1",
      "problem_contract_sha256": "3282a9c02aa13fba3ef2e85d9e49994ce6c25291cc4cf2241ba618adf53056c1",
      "problem_id": "problem:um-ep-1029-erd-s-problem-1029-0fa54302",
      "route_id": "route:um-ep-1029-erd-s-problem-1029-0fa54302-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1029-erd-s-problem-1029-0fa54302-source-fidelity-01",
      "graph_id": "graph:um-ep-1029-erd-s-problem-1029-0fa54302-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1029-erd-s-problem-1029-0fa54302-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1029-erd-s-problem-1029-0fa54302-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "If $R(k)$ is the Ramsey number for $K_k$, the minimal $n$ such that every $2$-colouring of the edges of $K_n$ contains a monochromatic copy of $K_k$, then $ \\frac{R(k)}{k2^{k/2}}\\to \\infty. $"
          },
          "statement_sha256": "a385a8f7c1c32dff0b21a37a8f49f2ba16b865950bc573e30e287737255a3385"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1029-erd-s-problem-1029-0fa54302-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1029-erd-s-problem-1029-0fa54302-root",
      "route_id": "route:um-ep-1029-erd-s-problem-1029-0fa54302-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1029-574eec3f7542",
        "url": "https://www.unsolvedmath.com/problems/EP-1029"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
